              ...
              a.a.createElement(
                ...
                a.a.createElement(
                  ...
                  a.a.createElement(
                    ...
                    a.a.createElement("div", { className: "hamburger-inner" })
                  )
                )
              ),
              a.a.createElement(
                ...
                a.a.createElement(
                  ...
                  a.a.createElement(
                    ...
                    a.a.createElement(o.Link, { to: "/" }, "Início")
                  ),
                  a.a.createElement(
                    "li",
                    { className: "nav-tags", role: "menuitem" },
                    a.a.createElement(o.Link, { to: "/tags" }, "Cardápio")
                  ),
                  a.a.createElement(
                    "li",
                    { className: "nav-elements", role: "menuitem" },
                    a.a.createElement(o.Link, { to: "/blog" }, "Eventos")
                  ),
                  a.a.createElement(
                    "li",
                    { className: "nav-about", role: "menuitem" },
                    a.a.createElement(o.Link, { to: "/about" }, "Saiba +")
                  )
                )
              ),
              a.a.createElement(
              ...
              a.a.createElement(
                ...
                a.a.createElement(
                  ...
                  a.a.createElement(
                    ...
                    {
                      href:
                        "https://api.whatsapp.com/send?phone=5519992094654&text=Olá,%20eu%20gostaria%20de%20fazer%20um%20pedido",
                      title: "Whatsapp",
                      target: "_blank",
    ...
    TJpk: function(e, t, n) {
      ...
      var d,
        ...
        S =
          ...
          (m = A = (function(e) {
            function t() {
              return E(this, t), p(this, e.apply(this, arguments))
            }
            return (
              (function(e, t) {
          ...
          return (function e(t, n) {
            ...
            if (t && n && "object" == typeof t && "object" == typeof n) {
              ...
              var f = t instanceof Date,
                E = n instanceof Date
              if (f != E) return !1
              if (f && E) return t.getTime() == n.getTime()
              var p = t instanceof RegExp,
                d = n instanceof RegExp
              if (p != d) return !1
              if (p && d) return t.toString() == n.toString()
              var A = a(t)
              if ((u = A.length) !== a(n).length) return !1
              for (c = u; 0 != c--; ) if (!o.call(n, A[c])) return !1
              if (i && t instanceof Element && n instanceof Element)
                return t === n
              for (c = u; 0 != c--; )
                if (!(("_owner" === (s = A[c]) && t.$$typeof) || e(t[s], n[s])))
                  return !1
              return !0
            }
            return t != t && n != n
    ...
    v1p5: function(e, t, n) {
      ;(function(e) {
        ...
        var s,
          ...
          T = function(e) {
            var t = A(e, c.TAG_NAMES.TITLE),
              n = A(e, c.HELMET_PROPS.TITLE_TEMPLATE)
            if (n && t)
              return n.replace(/%s/g, function() {
                return t
              })
            var r = A(e, c.HELMET_PROPS.DEFAULT_TITLE)
            return t || r || void 0
          },
          f = function(e) {
            return A(e, c.HELMET_PROPS.ON_CHANGE_CLIENT_STATE) || function() {}
          },
          E = function(e, t) {
            return t
              .filter(function(t) {
          ...
          v = function(e, t) {
            var n = e.baseTag,
              ...
              f = e.title,
              E = e.titleAttributes
            P(c.TAG_NAMES.BODY, r), P(c.TAG_NAMES.HTML, a), R(f, E)
            var p = {
                baseTag: O(c.TAG_NAMES.BASE, n),
                linkTags: O(c.TAG_NAMES.LINK, o),
                metaTags: O(c.TAG_NAMES.META, i),
                noscriptTags: O(c.TAG_NAMES.NOSCRIPT, u),
                scriptTags: O(c.TAG_NAMES.SCRIPT, l),
                styleTags: O(c.TAG_NAMES.STYLE, T),
              },
              d = {},
              A = {}
        ...
        ;(t.convertReactPropstoHtmlAttributes = function(e) {
          ...
          (t.mapStateOnServer = function(e) {
            ...
            return {
              ...
              noscript: N(c.TAG_NAMES.NOSCRIPT, u, r),
              script: N(c.TAG_NAMES.SCRIPT, s, r),
              style: N(c.TAG_NAMES.STYLE, l, r),
              title: N(c.TAG_NAMES.TITLE, { title: f, titleAttributes: E }, r),
            }
          }),
          (t.reducePropsToState = function(e) {
            return {
              ...
              defer: A(e, c.HELMET_PROPS.DEFER),
              encode: A(e, c.HELMET_PROPS.ENCODE_SPECIAL_CHARACTERS),
              ...
              styleTags: d(c.TAG_NAMES.STYLE, [c.TAG_PROPERTIES.CSS_TEXT], e),
              title: T(e),
    ...
    vrFN: function(e, t, n) {
      ...
      function u(e) {
        var t = e.description,
          ...
          o = e.keywords,
          u = e.title,
          s = Object(c.useStaticQuery)("63159454").site,
...
//# sourceMappingURL=7f8799314d9f0b023ddee55684fc4e4d2439ad59-e10bd8e88b9aafefdc85.js.map
